<html>
<head>
<title>D&eacoute;partament</title>
...
<body id="page-top">
	<div id="wrapper">
		<ul
			...
			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="lieu.jsp">
					<i class="fas fa-fw fa-table"></i> <span>Lieux</span>
			</a></li>

			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="departament.jsp"> <i
					class="fas fa-fw fa-table"></i> <span>Départaments</span></a></li>
			<!-- Nav Item - Tables -->
